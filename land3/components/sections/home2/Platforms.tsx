...
export default function Platforms() {
  ...
  return (
    <>
        <section className="platforms-style1 platforms-style1--style1">
                ...
                <div className="platforms-style1__inner">
                    ...
                    <div className="platforms-style1__tab">
                        ...
                        <div className="platforms-style1__img">
                            <div className="shape">
                                <Image src="/assets/images/shapes/platforms-v1-shape11.png" alt="Shape" width={567} height={370} priority />
                            </div>
                            <div className="inner">
                                <Image src="/assets/images/resources/platforms-v1-2.png" alt="Image" width={455} height={565} priority />
                            </div>
                        </div>
                        ...
                        <div className="platforms-style1__content">
                            ...
                            <div className="platforms-style1__tab-btn platforms-style1__tab-btn--style2">
                                        ...
                                        <div className="platforms-style1-downlode">
                                            <div className="row">
                                                <div className="col-xl-4 col-lg-6 col-md-6">
                                                    <div className="platforms-style1-downlode-single platforms-style1-downlode-single--style2">
                                                        <div className="platforms-style1-downlode-single__bg"
                                                            style={{ backgroundImage: "url(swfx/assets/images/shapes/platforms-v1-shape22.png)" }}>
                                                        </div>
                                                        <div className="shape1">
                                                            <Image src="/assets/images/shapes/platforms-v1-shape33.png" alt="Shape" width={370} height={217} priority className="zoominout" />
                                                        </div>
                                                        <div className="title">
                                                ...
                                                <div className="col-xl-4 col-lg-6 col-md-6">
                                                    <div className="platforms-style1-downlode-single platforms-style1-downlode-single--style2">
                                                        <div className="platforms-style1-downlode-single__bg"
                                                            style={{ backgroundImage: "url(/assets/images/shapes/platforms-v1-shape22.png)" }}>
                                                        </div>
                                                        <div className="shape2">
                                                            <Image src="/assets/images/shapes/platforms-v1-shape44.png" alt="Shape" width={370} height={206} priority className="zoominout" />
                                                        </div>
                                                        <div className="title">
