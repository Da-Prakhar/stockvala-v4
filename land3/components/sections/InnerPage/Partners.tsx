                ...
                <div className="row">
                    <div className="col-xl-6 col-lg-6">
                        ...
                        <div className="partner-style1__img">
                            <Image src="/assets/images/about/partners-v1-img1.webp" alt="Image" width={571} height={455} priority />
                        </div>
                        </FadeIn>
                    </div>
                    ...
                    <div className="col-xl-6 col-lg-6">
                        ...
                        <div className="partner-style1__brand">
                            <ul className="clearfix">
                                <li>
                                    <Link href="#">
                                        <Image src="/assets/images/about/brand-1-1.webp" alt="Image" width={285} height={150} priority />
                                    </Link>
                                </li>
                                <li>
                                    <Link href="#">
                                        <Image src="/assets/images/about/brand-1-2.webp" alt="Image" width={285} height={150} priority />
                                    </Link>
                                </li>
                            </ul>
                            <ul className="middle-box clearfix">
                                <li>
                                    <Link href="#">
                                        <Image src="/assets/images/about/brand-1-3.webp" alt="Image" width={285} height={150} priority />
                                    </Link>
                                </li>
                                ...
                                <li>
                                    <Link href="#">
                                        <Image src="/assets/images/about/brand-1-4.webp" alt="Image" width={285} height={150} priority />
                                    </Link>
                                </li>
                            </ul>
                            <ul className="clearfix">
