                                        ...
                                        <div className="row">
                                            <div className="col-xl-6 col-lg-6">
                                                <div className="single-instruments-style1__img">
                                                    <Image src="/assets/images/home/explore-global.png" alt="Chart Image" width={540} height={420} priority />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-6">
                                ...
                                <div className="instruments-style1-tab-content-box-item">
                                    ...
                                    <div className="single-instruments-style1">
                                        <div className="row">
                                            <div className="col-xl-6 col-lg-6">
                                                <div className="single-instruments-style1__img">
                                                    <Image src="/assets/images/home/about.png" alt="Chart Image" width={540} height={420} priority />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-6">
                                                <div className="single-instruments-style1__content">
                                ...
                                <div className="instruments-style1-tab-content-box-item">
                                    ...
                                    <div className="single-instruments-style1">
                                        <div className="row">
                                            <div className="col-xl-6 col-lg-6">
                                                <div className="single-instruments-style1__img">
                                                    <Image src="/assets/images/home/instruments-v1-3.webp" alt="Chart Image" width={540} height={420} priority />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-6">
                                                <div className="single-instruments-style1__content">
                                ...
                                <div className="instruments-style1-tab-content-box-item">
                                    ...
                                    <div className="single-instruments-style1">
                                        <div className="row">
                                            <div className="col-xl-6 col-lg-6">
                                                <div className="single-instruments-style1__img">
                                                    <Image src="/assets/images/home/instruments-v1-4.webp" alt="Chart Image" width={540} height={420} priority />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-6">
                                                <div className="single-instruments-style1__content">
                                ...
                                <div className="instruments-style1-tab-content-box-item">
                                    ...
                                    <div className="single-instruments-style1">
                                        <div className="row">
                                            <div className="col-xl-6 col-lg-6">
                                                <div className="single-instruments-style1__img">
                                                    <Image src="/assets/images/home/blog-v1-1.webp" alt="Chart Image" width={540} height={420} priority />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-6">
                                                <div className="single-instruments-style1__content">
