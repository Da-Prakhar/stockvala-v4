  ...
  return (
    <>
        <section className="main-slider-style1">
            <div className="main-slider-style1__inner d-none d-lg-block">
                <div className="top-box text-center">
                    ...
                    <div className="img-box">
                        <Image src="/assets/images/home/banner-mobile.png" alt="Image" width={235} height={176} priority />
                    </div>
            ...
            <div className="">
                <Swiper {...swiperOptions} className="swiper-container banner-slider-two">
                    ...
                    <SwiperSlide className="swiper-slide">
                        <div className="image-layer" style={{ backgroundImage: "url(/assets/images/home/banner.jpg)" }}>
                        </div>
                        <div className="container">
                            <div className="content-box">
                                <div className="big-title">
                                   <h2> Financial growth<br /> with Star Wave Holding</h2>
                                </div>
                                <div className="text">
                                <p>Star Wave Holding delivers trusted investment solutions, helping individuals and businesses achieve sustainable growth through strategic financial opportunities and expert guidance.</p>
                                </div>
