                    ...
                    <div className="col-xl-12 relative">
                        <Swiper {...swiperOptions} className="account-style1-carousel">
                            <SwiperSlide>
                                <div className="single-account-style1">
                                    ...
                                    <div className="img-box">
                                        <div className="inner">
                                            <Image src="/assets/images/home/account-1.png" alt="Image" width={370} height={240} priority />
                                        </div>
                            ...
                            <SwiperSlide>
                                <div className="single-account-style1">
                                    <div className="content-box">
                                        <h3><Link href="#">Cent Account</Link></h3>
                                        <p>Cases are perfectly simple and easy to distinguish in a free hour...</p>
                                    </div>
                                    <div className="img-box">
                                        <div className="inner">
                                            <Image src="/assets/images/home/account-2.png" alt="Image" width={370} height={240} priority />
                                        </div>
                                        <div className="overlay-icon">
                            ...
                            <SwiperSlide>
                                <div className="single-account-style1">
                                    ...
                                    <div className="img-box">
                                        <div className="inner">
                                            <Image src="/assets/images/home/account-3.png" alt="Image" width={370} height={240} priority />
                                        </div>
                                        <div className="overlay-icon">
