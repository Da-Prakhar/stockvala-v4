                ...
                <div className="sidebar-textwidget">
                    <div className="sidebar-info-contents">
                        <div className="content-inner">
                            <div className="logo">
                                <Link href="/">
                                    <Image src="/assets/images/resources/side-content__logo-1.png" alt="Logo" width={189} height={28} priority />
                                </Link>
                            </div>
...
Sheridan, Wyoming 82801</p>
                                    ...
                                    <li>
                                        <div className="inner">
                                            <div className="text">
                                                <p><Link href="tel:180098765432">+1 (858) 409-6751</Link></p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="inner">
                                            <div className="text">
                                                <p><Link href="mailto:sendmail@Swfx.com">sendmail@Swfx.com</Link></p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
