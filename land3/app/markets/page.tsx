                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="single-market-style1">
                                    <div className="img-box img-box3">
                                        <Image src="/assets/images/markets/market-v1-6.webp" alt="Image" width={200} height={200} priority />
                                    </div>
                                    <div className="content-box">
                                        ...
                                        <div className="text">
                                            ...
                                            <h3>
                                                <Link href="markets1-trade-forex.html">Trade Forex</Link>
                                            </h3>
                                        </div>
                                        ...
                                        <div className="btn-box">
                                            <Link className="btn-one" href="#">
                                                <span className="txt">Open Account</span>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="single-market-style1">
                                    <div className="img-box img-box3">
                                        <Image src="/assets/images/markets/market-v1-2.webp" alt="Image" width={200} height={200} priority />
                                    </div>
                                    <div className="content-box">
                                        <div className="shape"
                                            style={{ backgroundImage: "url(/assets/images/shapes/market-v2-shape1.png)" }}>
                                        ...
                                        <div className="text">
                                            ...
                                            <div className="title ps-3">
                                            <h3>
                                                <Link href="markets2-stock-market.html">Stock Market</Link>
                                            </h3>
                                        </div>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="single-market-style1">
                                    <div className="img-box img-box3">
                                        <Image src="/assets/images/markets/market-v1-3.webp" alt="Image" width={200} height={200} priority />
                                    </div>
                                    <div className="content-box">
                                        <div className="shape"
                                            style={{ backgroundImage: "url(/assets/images/shapes/market-v2-shape1.png)" }}>
                                        ...
                                        <div className="text">
                                            <div className="icon">
                                             ...
                                             <div className="title ps-3">
                                            <h3>
                                                <Link href="markets3-commodities-market.html">Commodities Market</Link>
                                            </h3>
                                        </div>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="single-market-style1">
                                    <div className="img-box img-box3">
                                        <Image src="/assets/images/markets/market-v1-4.webp" alt="Image" width={200} height={200} priority />
                                    </div>
                                    <div className="content-box">
                                        <div className="shape"
                                            style={{ backgroundImage: "url(/assets/images/shapes/market-v2-shape1.png)" }}>
                                        ...
                                        <div className="text">
                                            <div className="icon">
                                               ...
                                               <div className="title ps-3">
                                            <h3>
                                                <Link href="markets4-crypto-market.html">Crypto Market</Link>
                                            </h3>
                                        </div>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="single-market-style1">
                                    <div className="img-box img-box3">
                                        <Image src="/assets/images/markets/market-v1-5.webp" alt="Image" width={200} height={200} priority />
                                    </div>
                                    <div className="content-box">
                                        <div className="shape"
                                            style={{ backgroundImage: "url(/assets/images/shapes/market-v2-shape1.png)" }}>
                                        ...
                                        <div className="text">
                                            <div className="icon">
                                             ...
                                             <div className="title ps-3">
                                            <h3>
                                                <Link href="markets5-futures-market.html">Futures Market</Link>
                                            </h3>
                                        </div>
                                            {/* <p>Beguiled and demoralized by the charms of pleasure of the moment...</p> */}
                                        </div>
                                    ...
                                    <div className="content-box">
                                        ...
                                        <div className="text">
                                            <div className="icon">
                                              ...
                                              <div className="title ps-3">
                                            <h3>
                                                <Link href="markets6-options-market.html">Options Market</Link>
                                            </h3>
                                        </div>
                                            {/* <p>Moment so blinded desire that they cannot foresee all are bound ensue...</p> */}
                                        </div>
                            ...
                            <div className="slogan-style2__big-title">
                                <Marquee speed={30} direction="left" pauseOnHover className="slogan-style2-scrolling-text">
                                    <ul className="list marquee_mode-rightToLeft">
                                        <li className="item">Star Wave Holding </li>
                                    </ul>
                                </Marquee>
                            </div>
