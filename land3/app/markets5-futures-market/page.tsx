...
export default function Features_Marketing() {
    ...
    return (
        <div className="body-bg-1">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Futures Market" breadcrumbTitleTwo="Markets">
                            ...
                            <div className="row">
                                ...
                                <div className="col-xl-6">
                                    <div className="trade-forex-style1__img">
                                        <Image src="/assets/images/trade-forex/trade-forex-v1.webp" alt="Image" width={570} height={525} priority />
                                    </div>
                                </div>
