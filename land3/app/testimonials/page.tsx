                        ...
                        <div className="row masonary-layout">
                                ...
                                <div className="single-testimonial-style1">
                                    ...
                                    <div className="text-box">
                                        <p>The platform&apos;s tools and resources significantly improved
                                            my trading strategy. swfx has been instrumental in my
                                            trading success.</p>
                                    </div>
                            ...
                            <div className="col-xl-4">
                                <div className="single-testimonial-style1">
                                    ...
                                    <div className="text-box">
                                        <p>I&apos;ve found swfx to be incredibly reliable and user-friendly.
                            ...
                            <div className="col-xl-4">
                                <div className="single-testimonial-style1">
                                    ...
                                    <div className="text-box">
                                        <p>Trading with swfx has been a great experience. The
