...
export default function Islamic_Account() {

    return (
        <div className="body-bg-1">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Islamic Account" breadcrumbTitleTwo="Trading">
                                    ...
                                    <div className="account-detail-style1__sidebar-info">
                                        ...
                                        <ul className="phn-email">
                                            <li>
                                                ...
                                                <div className="text">
                                                    <h4>Phone</h4>
                                                    <Link href="tel:+80098765432">+1 (858) 409-6751</Link>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div className="text">
                                                    <h4>Email</h4>
                                                    <Link href="mailto:sendyourmail@Swfx.com">sendyourmail@Swfx.com</Link>
                                                </div>
                                            </li>
                                        </ul>
                                        <div className="live-chat-box">
                                            <div className="live-chat-box__inner">
                                                <ul>
                                                    <li>
                                                        <div className="img">
                                                            <Image src="/assets/images/our-accounts/account-v1-top1.webp" alt="Image" width={60} height={60} priority />
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div className="icon">
                                        ...
                                        <div className="row">
                                            <div className="col-xl-6 col-lg-12 col-md-6">
                                                <div className="offers-box-img">
                                                    <Image src="/assets/images/our-accounts/account-detail-v1-img2.webp" alt="Image" width={350} height={375} priority />
                                                </div>
                                            </div>
                                            <div className="col-xl-6 col-lg-12 col-md-6">
